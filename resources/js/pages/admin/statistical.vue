<template>
    <div >
        <div class="head-ps">THỐNG KÊ</div>
        <div class="table-item " >
            <table class="table table-bordered">
                ...
                <tr v-for="book in comments" :key="book.id">
                    ...
                    <td class="" style="    width: 15%;">{{ book.totalView }}</td>
                    <td class="" style="    width: 15%;" >{{ getRandomInt(7) }}</td>
                    <td class="" style="    width: 15%;">{{ getRandomInt(20) }}</td>
    ...
    export default {
        ...
        methods: {
            ...
            getUsers(pageNum){
                ...
                axios.get('/allBook?page=' + pageNum)
                    .then(response => {
                        console.log(response.data.users);
                        this.comments = response.data.books.data;
